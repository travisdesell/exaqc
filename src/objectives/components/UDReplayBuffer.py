...
class UDReplayBuffer:
    ...
    def __init__(
        self, capacity, alpha=0.6, beta=0.4, beta_increment=0.001, epsilon=1e-6
    ):
    ...
    def sample(self, batch_size):
        ...
        states, actions, rewards, next_states, dones, u_eps, u_als = zip(
            *[self._memory[idx] for idx in idxs]
        )
